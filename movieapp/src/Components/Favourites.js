...
export default class Favourites extends Component {
 ...
 handleDelete=(id)=>{
  ...
  localStorage.setItem("movies-app",JSON.stringify(newarr)) //ye kya h
 }
  ...
  render() {
    ...
    //   filterarr=this.state.movies
    // }
    if(this.state.currgen!='All Genres'){  //ye kya lr rha h
          ...
          <ul class="list-group favourites-genres">
           ...
           <div className='col-lg-9 favourites-table col-sm-12'>
             <div className='row'>
               ...
               <input type='text' className='input-group-text col-8' placeholder='Search' value={this.state.currText} onChange={(e)=>this.setState({currText:e.target.value})}></input>
